...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Events List </h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2"><a  href="{{ route('events.create') }}">Add New Event</a></button>
            <div class="dropdown">
                           ...
                           <td class="w-40">
                                <div class="flex">
                                     <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="" class="tooltip rounded-full" src="{{ asset('dist/images/'.$events->image) }}" title="">
                                    </div>
