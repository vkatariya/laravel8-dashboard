...
@endif
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" name="title" type="text" class="form-control w-full" placeholder="Event title">
                </div>
                <div>
                    <label for="crud-form-1" class="form-label">URL</label>
                    <input id="crud-form-1" type="text" name="url" class="form-control w-full" placeholder="Website url">
                </div>
